...
#[allow(dead_code)] pub struct AgentConversationsModel;
#[allow(dead_code)] pub struct AgentManagementEvent;
#[allow(dead_code)] pub struct AgentManagementTelemetryEvent;
#[allow(dead_code)] pub struct AgentManagementView;
#[allow(dead_code)] pub struct AgentManagementViewEvent;
#[allow(dead_code)] pub struct AgentNotificationToastStack;
#[allow(dead_code)] pub struct AgentToolbarEditorEvent;
#[allow(dead_code)] pub struct AgentToolbarEditorModal;
#[allow(dead_code)] pub struct AgentToolbarEditorMode;
#[allow(dead_code)] pub struct AgentViewEntryOrigin;
#[allow(dead_code)] pub struct AIClient;
#[allow(dead_code)] pub struct AIConversationId;
#[allow(dead_code)] pub struct AIDocumentId;
#[allow(dead_code)] pub struct AIDocumentModel;
#[allow(dead_code)] pub struct AIExecutionProfilesModel;
#[allow(dead_code)] pub struct AIFactManager;
#[allow(dead_code)] pub struct AIFactPage;
#[allow(dead_code)] pub struct AIFactView;
#[allow(dead_code)] pub struct AIFactViewEvent;
#[allow(dead_code)] pub struct AIRequestUsageModel;
#[allow(dead_code)] pub struct AmbientAgentTaskId;
#[allow(dead_code)] pub struct AnonymousUserSignupEntrypoint;
#[allow(dead_code)] pub struct ArgumentsState;
...
#[allow(dead_code)] pub struct AuthViewEvent;
#[allow(dead_code)] pub struct AuthViewVariant;
#[allow(dead_code)] pub struct BlocklistAIHistoryEvent;
#[allow(dead_code)] pub struct ChipRuntimeCapabilities;
#[allow(dead_code)] pub struct ClientProfileId;
#[allow(dead_code)] pub struct CloseTarget;
#[allow(dead_code)] pub struct CloudAgentTelemetryEvent;
#[allow(dead_code)] pub struct CloudConversationData;
#[allow(dead_code)] pub struct CloudModeEntryPoint;
#[allow(dead_code)] pub struct CloudModel;
#[allow(dead_code)] pub struct CloudObjectToastMessage;
...
#[allow(dead_code)] pub struct CodeReviewPaneEntrypoint;
#[allow(dead_code)] pub struct CodeReviewTelemetryEvent;
#[allow(dead_code)] pub struct CodingPanelEnablementState;
#[allow(dead_code)] pub struct ConversationOrTask;
#[allow(dead_code)] pub struct DiffStateModel;
#[allow(dead_code)] pub struct DriveObjectType;
#[allow(dead_code)] pub struct DrivePanel;
#[allow(dead_code)] pub struct DrivePanelEvent;
#[allow(dead_code)] pub struct EntrypointType;
#[allow(dead_code)] pub struct EnvVarTelemetryMetadata;
#[allow(dead_code)] pub struct ExecutionProfileEditorManager;
...
#[allow(dead_code)] pub struct GlobalCodeReviewModel;
#[allow(dead_code)] pub struct ImportModal;
#[allow(dead_code)] pub struct ImportModalEvent;
#[allow(dead_code)] pub struct JsonObjectType;
#[allow(dead_code)] pub struct KnowledgePaneEntrypoint;
#[allow(dead_code)] pub struct LaunchConfigUiLocation;
#[allow(dead_code)] pub struct LLMPreferences;
#[allow(dead_code)] pub struct MCPServerCollectionPaneEntrypoint;
#[allow(dead_code)] pub struct NetworkLogPaneManager;
#[allow(dead_code)] pub struct NotificationFilter;
#[allow(dead_code)] pub struct NotificationMailboxView;
#[allow(dead_code)] pub struct NotificationMailboxViewEvent;
#[allow(dead_code)] pub struct NotificationsTurnedOnSource;
#[allow(dead_code)] pub struct ObjectOperation;
#[allow(dead_code)] pub struct ObjectType;
#[allow(dead_code)] pub struct ObjectUid;
#[allow(dead_code)] pub struct OpenedWarpAISource;
#[allow(dead_code)] pub struct OpenWarpDriveObjectSettings;
#[allow(dead_code)] pub struct OperationSuccessType;
#[allow(dead_code)] pub struct Owner;
#[allow(dead_code)] pub struct PaletteSource;
#[allow(dead_code)] pub struct PendingQueryState;
#[allow(dead_code)] pub struct PersistedWorkspace;
#[allow(dead_code)] pub struct PromptEditorModal;
#[allow(dead_code)] pub struct PromptEditorModalEvent;
#[allow(dead_code)] pub struct PromptEditorOpenSource;
#[allow(dead_code)] pub struct ReferralThemeEvent;
#[allow(dead_code)] pub struct RewardEvent;
#[allow(dead_code)] pub struct RewardKind;
#[allow(dead_code)] pub struct RewardView;
#[allow(dead_code)] pub struct SerializedBlockListItem;
#[allow(dead_code)] pub struct ServerApi;
#[allow(dead_code)] pub struct ServerApiEvent;
#[allow(dead_code)] pub struct ServerApiProvider;
#[allow(dead_code)] pub struct ServerConversationToken;
#[allow(dead_code)] pub struct ServerId;
#[allow(dead_code)] pub struct ServerTime;
#[allow(dead_code)] pub struct SessionNavigationData;
#[allow(dead_code)] pub struct SessionSource;
#[allow(dead_code)] pub struct SharedObjectsCreationDeniedModal;
#[allow(dead_code)] pub struct SharedObjectsCreationDeniedModalEvent;
#[allow(dead_code)] pub struct SharingDialogSource;
#[allow(dead_code)] pub struct SkillManager;
#[allow(dead_code)] pub struct SlashCommandRequest;
#[allow(dead_code)] pub struct Space;
#[allow(dead_code)] pub struct SuggestedAgentModeWorkflowAndId;
#[allow(dead_code)] pub struct SuggestedAgentModeWorkflowModal;
#[allow(dead_code)] pub struct SuggestedAgentModeWorkflowModalEvent;
#[allow(dead_code)] pub struct SuggestedRuleAndId;
#[allow(dead_code)] pub struct SuggestedRuleModal;
#[allow(dead_code)] pub struct SuggestedRuleModalEvent;
#[allow(dead_code)] pub type SyncId = String;
#[allow(dead_code)] pub struct TabRenameEvent;
#[allow(dead_code)] pub struct TierLimitHitEvent;
#[allow(dead_code)] pub struct UpdateManager;
#[allow(dead_code)] pub struct UpdateManagerEvent;
#[allow(dead_code)] pub struct WarpAiExecutionContext;
#[allow(dead_code)] pub type WarpDriveItemId = String;
#[allow(dead_code)] pub struct WarpDriveSettings;
#[allow(dead_code)] pub struct WarpDriveSettingsChangedEvent;
#[allow(dead_code)] pub struct WarpDriveSource;
#[allow(dead_code)] pub struct WorkflowModal;
#[allow(dead_code)] pub struct WorkflowModalEvent;
#[allow(dead_code)] pub const FORK_PREFIX: &str = "";
// --- end stubs ----------------------------------------------------------
